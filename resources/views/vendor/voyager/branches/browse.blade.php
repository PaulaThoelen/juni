...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="{{ $dataType->icon }}"></i> <!-- {{ $dataType->display_name_plural }} --> Takken
        </h1>
...
@section('content')
    <div class="page-content browse container-fluid">
        ...
        <ul class="list-group">
            <li class="list-group-item"><a href="/mei/public/admin/messages">Berichten</a></li>
            <li class="list-group-item"><a href="/mei/public/admin/meetings">Vergaderingen</a></li>
            <li class="list-group-item"><a href="/mei/public/admin/places">Plaatsen</a></li>
        </ul>
        <div class="row">
            <div class="col-md-12">
