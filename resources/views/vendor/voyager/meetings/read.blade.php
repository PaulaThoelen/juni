...
@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i> <!-- {{ __('voyager::generic.viewing') }} {{ ucfirst($dataType->display_name_singular) }} --> Vergadering &nbsp;
    ...
    <div class="page-content read container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><h4><a href="/mei/public/admin/places">Klik hier voor het adres</a><h4></li>
                </ul>
            </div>
        </div>
    </div>
